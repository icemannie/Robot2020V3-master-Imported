...
public class LimeLight {
    ...
    public void periodic() {
        SmartDashboard.putBoolean("VisionConnected", isConnected());
        SmartDashboard.putBoolean("VisionTargetFound", getIsTargetFound());
        SmartDashboard.putBoolean("VertTargetOn", getVertOnTarget());
        SmartDashboard.putBoolean("HorTargetOn", getHorOnTarget());
